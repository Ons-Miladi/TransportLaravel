...
<div class="main-content">
    ...
    <div class="container-fluid mt--7" style="margin-top: 0 !important;" >
      ...
      <div class="row mt-5">
      {{ Form::open(array('route' => 'voiture.store', 'method' => 'post')) }}
              ...
              <table class="table align-items-center table-dark table-flush">
                ...
                @foreach($voitures as $voiture)
                 <tr>
                    ...
                    <td><a href="{{route('voiture.edit',$voiture->id)}}">modifier</a></td>
                     <td><a href="{{route('voiture.destroy',$voiture->id)}}">supprimer</a></td>
